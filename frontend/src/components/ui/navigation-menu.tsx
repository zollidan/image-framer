...
/**
 * A collection of components for displaying a list of links as a navigation menu.
 *
 ...
 * @returns {JSX.Element} The rendered NavigationMenuItem component.
 */
...
/**
 * A button that triggers a navigation menu to open.
 *
